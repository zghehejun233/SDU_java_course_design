...
import com.surui.java_course_design.service.intf.UserServiceDefinition;
...
public class UserController {
    @Resource
    private UserServiceDefinition userServiceDefinition;

    @PostMapping(value = "/")
    public JsonResponse<String> postUser(@RequestBody User user) {
        log.debug("postUser starts.");
        userServiceDefinition.addUser(user);
